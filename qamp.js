	...
	**/
	...
	{   
		...
		var ampObj = 
		{
			...
			randomizeLabelSides : true, //IF false, then label1 is on the left, and label2 is on the right.
			...
			trialsInBlock : [1], //Number of trials in each block 
			...
			'また，他のtargetCatよりも視覚的にleftAttributeの場合は<b>leftKey</b> キーを押してください。<br/><br/>' + 
			'それぞれのtargetCatを評価し，その前に呈示される文章は評価しないでください。 ' + 
			'呈示される文章に影響される可能性もありますが，直感に従ってください。<br/><br/>' + 
			'<p style="font-size:16px; text-align:center; font-family:arial"><color="000000"><br/><br/>' + 
			...
			'全てのセクションが終了しました。<br/><br/>スペースを押して次に進んでください。</p></div>', 
        ...
        */
		...
		var layout2 = [
				{location:{left:2,top:2},media:{word:'キー:'+ piCurrent.leftKey.toUpperCase()}, css:{color:piCurrent.fontColor,'font-size':'1em'}},
				{location:{right:2,top:2},media:{word:'キー:'+ piCurrent.rightKey.toUpperCase()},  css:{color:piCurrent.fontColor,'font-size':'1em'}},
