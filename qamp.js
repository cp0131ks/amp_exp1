...
*/
		...
		***/
		...
		function fromTemplate(params) {//params: template, blockNum.
		...
		***/
		...
		function getPreference(inRespObj) {
			...
			if (inRespObj[piCurrent.primeCats[0].nameForLogging] &&
				...
				var diff = 0;
				if (inRespObj[piCurrent.primeCats[0].nameForLogging][piCurrent.sortingLabel2]) {//Pleasant count for first prime category
					diff += inRespObj[piCurrent.primeCats[0].nameForLogging][piCurrent.sortingLabel2];
				}
				if (inRespObj[piCurrent.primeCats[0].nameForLogging][piCurrent.sortingLabel1]) {//Unpleasant count for first prime category
					diff -= inRespObj[piCurrent.primeCats[0].nameForLogging][piCurrent.sortingLabel1];
				}
				if (inRespObj[piCurrent.primeCats[1].nameForLogging][piCurrent.sortingLabel2]) {//Pleasant count for the second prime category
					diff -= inRespObj[piCurrent.primeCats[1].nameForLogging][piCurrent.sortingLabel2];
				}
				if (inRespObj[piCurrent.primeCats[1].nameForLogging][piCurrent.sortingLabel1]) {//Unpleasant count for the second prime category
					diff += inRespObj[piCurrent.primeCats[1].nameForLogging][piCurrent.sortingLabel1];
				}

				if (diff > 0) {//Preference for the first prime over the second prime
				...
				else if (diff < 0) {//Preference for the second prime over the first prime
					preference = replaceCats(piCurrent.fb_att2WithCatA_att1withCatB,
